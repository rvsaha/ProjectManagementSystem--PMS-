...
<body>
	...
	<h1 >Change Password</h1>
		    ...
		    <div class="pass_show" style="border:1 solid black;"> 
                <input type="password" name="password"  class="form-control" style="all: unset;all: initial;" placeholder="Current Password" required> 
            </div> 
